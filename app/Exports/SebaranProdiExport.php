...
class SebaranProdiExport implements FromView,WithEvents
{
    protected $request;
    ...
    public function view(): View
    {
        ...
        $sebaran =  DB::table('sebaran')
                             ...
                             'matkul.teori','matkul.kode_matkul','matkul.praktek','matkul.jam_minggu','sebaran.dosen_mengajar','sebaran.approved','prodi.id','matkul.kurikulum','sebaran.tahun_akademik')->orderBy('semester');
