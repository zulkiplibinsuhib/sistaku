...
<div class="row">
    ...
    <div class=" container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        <a href="dosen" class="info-box-icon bg-success elevation-1"><i
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        <a href="sebaran" class="info-box-icon bg-danger elevation-1"><i
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        <a href="rekap" class="info-box-icon bg-success elevation-1"><i
                                class="ion ion-stats-bars"></i></a>
                        <div class="info-box-content">
