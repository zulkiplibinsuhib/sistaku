...
<section class="content">
    ...
    <table class="table table-bordered">
        ...
        <tr><td><label for="kelas">Kelas</label></td><td><select class="form-control col-md-4" name="kelas" id="kelas-sebaran">
        ...
        <tr><td><label for="matkul">Mata Kuliah</label></td><td><select class="form-control col-md-4" name="mata_kuliah" id="matkul-sebaran">
